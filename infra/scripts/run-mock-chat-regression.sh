...
unset QWEN_API_KEY GLM_API_KEY DEEPSEEK_API_KEY KIMI_API_KEY WANXIANG_API_KEY COGVIEW_API_KEY
unset QWEN_ENABLED GLM_ENABLED DEEPSEEK_ENABLED KIMI_ENABLED WANXIANG_ENABLED COGVIEW_ENABLED
